...
inline void simdtrellis(unsigned int *nodemetric1, unsigned int *nodemetric2, unsigned int *metrictab, unsigned short *backptr, int vr, int vi)
{
}
...
inline void simdinitmetric(const cplxshort_t *channel, metrictab_t *metrictab)
{
}
